...
%>
	...
	<div id="nav">
		<ul>
			...
			<li><a href="ctmMagicBuy.jsp"><strong>마법구매</strong></a></li>
	  		...
	  		<thead>
   			...
   			<tbody>
				...
				<tr>
					...
					<td><%=sShopbalance %></td>
					<td>
					<input type="button" value="선택" onclick="location.href='ctmMagicBuy2.jsp?shopId=<%=sShopid%>'" 
